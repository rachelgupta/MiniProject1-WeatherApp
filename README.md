...
An application that gives weather details such as temperature(°C), humidity(%) and wind speed(km/h) for the city name that user enters. It also shows invalid city name for wrong inputs.
